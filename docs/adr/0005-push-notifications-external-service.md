...
> **Modèle de souscription** : depuis le passage au multi-appareils (collection `push_subscriptions`, endpoint `/api/push-subscription`), seul le modèle de souscription évolue — ce service externe reste inchangé. Voir [ADR-0014](0014-push-subscriptions-multi-device.md).
