...
const newCommentScopeOptions: Array<{
	...
	{
		value: "off",
		label: m.notif_scope_none(),
		hint: m.notif_scope_none_hint()
	},
	{
		value: "concerned",
	...
	{
		value: "all",
		label: m.notif_scope_all(),
		hint: m.notif_scope_all_hint()
	}
];
  ...
  {:else}
    ...
    >
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="label-text text-sm font-medium"
              >{m.notif_email_notifications()}</span
            >
          </div>
        </label>
        ...
        {#if pushSupported}
          ...
          >
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="label-text text-sm font-medium"
                >{m.notif_push_notifications()}</span
              >
            </div>
          </label>
        {/if}
      ...
      <fieldset
        class={[
          "fieldset",
          !prefs.email && !prefs.push && "pointer-events-none opacity-50",
        ]}
      >
        ...
        <div
          class="bg-base-200 border-base-300 space-y-2 rounded-lg border p-3"
        >
