<script lang="ts">
	...
	import { deletePlanning, updatePlanningWithOccurrences } from "$lib/services/planningActions";
...
<svelte:head>
	<title>{master?.title || m.admin_title_fallback()} {m.admin_title_suffix()}</title>
</svelte:head>
