...
<svelte:head>
	<title
		>{isNotFound ? m.error_page_title_404() : m.error_page_title_other()} · Oupla Planning</title
	>
</svelte:head>
	...
	<div class="max-w-md space-y-2">
		...
		{#if isInternalServerError && import.meta.env.DEV && page.error?.message}
			<details class="text-left">
				<summary class="text-base-content/50 cursor-pointer text-sm"
